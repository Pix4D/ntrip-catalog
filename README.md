...
Neither RTCM messages, nor the NTRIP handshake include any clarification about the cordinate reference system (CRS) that applies to the corrected coordinates.
